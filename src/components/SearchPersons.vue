  ...
  <div class="user-admin">
      ...
      <b-row>
        <b-col md="8" sm="12">
          <b-form-group label="Nome:" label-for="person-name">
            <b-form-input id="person-name" type="text" v-model="person.name" />
          </b-form-group>
        </b-col>
        <b-col md="4" sm="12">
    ...
    <b-table hover striped :items="persons" :fields="fields">
      <template slot="actions" slot-scope="data">
        ...
        <router-link :to="`/personAdmin/${data.item.id}`">
        <b-button
            variant="warning"
            @click="loadPersons(data.item.id)"
            class="mr-2"
          >
    ...
    return {
      ...
      fields: [
        ...
        { key: "email", label: "E-mail", sortable: true },
        {
          ...
          label: "Administrador",
          sortable: true
          ,formatter: (value) => (value === 1 ? "Administrador" : "Usuário"),
        },
